import { FailureRestartOption, ServiceConfigMode } from "../../../../../docs/docs";
import ContainerTemplate from "../../ContainerTemplate";

/**
 * TODO: Update the code so only the `addContent`, `incIndent` and `decIndent` methods are used.
 * The endLine and startLine methods should be integrated with the `addContent` method
 * and automatically append a newline character. This is easier for debugging.
 */
